...
import pl.yalgrin.playnite.simplesync.util.library.TagAssertionUtil
import pl.yalgrin.playnite.simplesync.util.library.TagFactoryUtil
...
class TagResourceTest extends AbstractObjectTest<Tag, TagDTO> {
    ...
    def "save, modify and delete and await the change stream"() {
        ...
        TagDTO modified = toSave.withName("some other name")
        TagDTO removed = modified.withRemoved(true)
        ...
        StepVerifier.create(responseFlux)
                ...
                .then {
                    def result = makeSaveRequest(toSave).expectStatus().is2xxSuccessful()
                            ...
                            .returnResult()
                            .responseBody
                    TagAssertionUtil.assertTag(toSave, result)
                ...
                .then {
                    def result = makeSaveRequest(modified).expectStatus().is2xxSuccessful()
                            ...
                            .returnResult()
                            .responseBody
                    TagAssertionUtil.assertTag(modified, result)
