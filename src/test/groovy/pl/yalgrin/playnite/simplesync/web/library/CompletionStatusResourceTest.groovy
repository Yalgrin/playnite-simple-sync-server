...
import pl.yalgrin.playnite.simplesync.util.library.CompletionStatusAssertionUtil
import pl.yalgrin.playnite.simplesync.util.library.CompletionStatusFactoryUtil
...
class CompletionStatusResourceTest extends AbstractObjectTest<CompletionStatus, CompletionStatusDTO> {
    ...
    def "save, modify and delete and await the change stream"() {
        ...
        CompletionStatusDTO modified = toSave.withName("some other name")
        CompletionStatusDTO removed = modified.withRemoved(true)
        ...
        StepVerifier.create(responseFlux)
                ...
                .then {
                    def result = makeSaveRequest(toSave).expectStatus().is2xxSuccessful()
                            .expectBody(CompletionStatusDTO.class)
                            .returnResult()
                            .responseBody
                ...
                .expectNextMatches { str ->
                    ...
                    assert change.getType() == ObjectType.COMPLETION_STATUS
